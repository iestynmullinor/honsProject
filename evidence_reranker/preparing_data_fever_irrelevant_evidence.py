...
for index, row in fener_nli_df.iterrows():
    ...
    #0 if the evidence is relevant, 1 if the evidence is irrelevant
...
if TEST_SET:
    ...
    fever_reranker_dev.to_csv("evidence_reranker/training_data/fever_reranker_dev_with_random_evidence.csv", index=False)
    fever_reranker_test.to_csv("evidence_reranker/training_data/fever_reranker_test_with_random_evidence.csv", index=False)

else:
    fever_reranker_training.to_csv("evidence_reranker/training_data/fever_reranker_train_with_random_evidence.csv", index=False)
